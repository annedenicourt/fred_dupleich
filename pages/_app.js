...
function MyApp({ Component, pageProps }) {
  ...
  return ( <>
    <Head>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Homemade+Apple&family=Josefin+Slab:wght@300&family=Noto+Sans+Mono:wght@100&family=Nunito:wght@200&display=swap" rel="stylesheet"></link>
      <script
