  ...
  return (
    <div className="">
      <Head>
        ...
        <main>
            <div className={`${styles.my_container2} container pb-2 mx-auto`}>            
                <div className="row mx-0 justify-content-center">
                    <NavBar/>
                </div>
                <div className="row mx-5 mb-2 pt-4 justify-content-center align-items-center">
                    <div className={`col col-xl-10 col-xxl-9`}> 
                        <div className="card p-0 mb-3">
                            <div className="row g-0 d-flex flex-column flex-lg-row align-items-center">
                                <div className="col">
                                    <img src="/images/mains2.jpeg" className="img-fluid rounded-start" alt="..."/>
                                </div>
                                <div className="col text-center">
                                    <div className="card-body">
                                        <h2 className=" mb-5 mb-lg-5 fs-1">Stages</h2>
                                        <h4 className="card-title fw-bold mb-3">Décors de Noel, pampilles, boules, guirlandes etc… en porcelaine papier</h4>
                                        <div className="">Quand ? Le samedi 13 novembre 2021 de 14h à 17h</div>
                                        <div className="mb-3 border-bottom pb-4">Prix ? 75€</div>
                                        <h4 className="card-title fw-bold mb-3">Fruits/légumes/végétaux à réaliser en grès de différentes couleurs</h4>
                ...
                <div className="row mx-5 mb-3 justify-content-center align-items-center">
                    <div className={`col text-center`}>
                        <div className="mt-1 mt-lg-1 text-center">Je vous propose aussi d'octobre à juin des cours hebdomadaires. <br/>Les cours et les stages se déroulent dans mon atelier situé à Tournefeuille.</div>
                        <div className="text-center mt-4 mt-xXl-2 mb-4">
                            <button className="border shadow rounded-pill px-3 py-2"><a className="text-reset" href="/contact">Renseignements / Inscriptions</a></button>            
                        </div>
                    </div>
                </div>
            </div>
